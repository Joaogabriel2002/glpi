    ...
    <div class="w-full max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-md mb-6">
        ...
        <form class="space-y-5 mb-10" method="post">
            ...
            <div class="text-right">
                <button type="submit"
                    class="bg-green-600 text-white px-6 py-2 rounded shadow hover:bg-green-700 transition duration-300">
                    Atualizar Dados
                </button>
            </div>
        </form>
        ...
        <form class="space-y-5" method="post">
            ...
            <div class="text-right">
                <button type="submit"
                    class="bg-blue-600 text-white px-6 py-2 rounded shadow hover:bg-blue-700 transition duration-300">
                    Atualizar Senha
                </button>
            </div>
        </form>
