<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        $tonnerSolicitacao->setCorTonner(isset($_POST['corTonner']) ? $_POST['corTonner'] : []);
    ...
    <div class="container">
        ...
        <input type="hidden"  name="status" value="Aberto">   
            ...
            <div id="coresContainer" style="display:none; margin-top: 10px;">
                <h3>Selecione as cores de tinta:</h3>
                <input type="checkbox" id="preto" name="corTonner[]" value="preto">
                <label for="preto">Preto</label><br>
                <input type="checkbox" id="azul" name="corTonner[]" value="azul">
                <label for="azul">Azul</label><br>
                <input type="checkbox" id="amarelo" name="corTonner[]" value="amarelo">
                <label for="amarelo">Amarelo</label><br>
                <input type="checkbox" id="vermelho" name="corTonner[]" value="vermelho">
